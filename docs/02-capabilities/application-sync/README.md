...
This domain composes persistence, interchange, coordination, messaging, API governance, workflow, authorization, privacy, object storage, and observability. It does not choose product datasets, authoritative replicas, topology, database, wire protocol, CRDT/OT algorithm, clock service, merge policy, offline-write eligibility, retention, or service objective.
