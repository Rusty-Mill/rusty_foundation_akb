...
| Policy evaluation | typed requests/decisions, immutable policies/data, composition, obligations/enforcement, partial evaluation/cache, distribution/simulation |
...
- [Content identification, inspection, quarantine, and safe-transformation foundations](content-inspection/README.md) — Draft
- [Data classification, sensitivity-labeling, information-protection, and loss-prevention foundations](information-protection/README.md) — Draft
...
- [Secrets lifecycle, dynamic credentials, and privileged-access brokerage foundations](secrets-lifecycle/README.md) — Draft
...
- [Application communications delivery and preference governance](application-communications/README.md) — Draft
- [Application audit trails, evidence ledgers, and compliance reporting](audit-evidence/README.md) — Draft
