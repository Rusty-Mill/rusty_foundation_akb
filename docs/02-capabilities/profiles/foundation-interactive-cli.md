...
- **RM-PROFILE-FOUNDATION-INTERACTIVE-CLI-0007:** The profile remains unsatisfied for an end-user terminal product until emulator, structured input, Unicode layout, renderer, and accessibility contracts are selected and evidenced.
...
Conformance spans ConPTY and POSIX PTY providers; bidirectional saturation; attachment and early-exit races; resize storms; W2 protocol corpus; hangup/shutdown; sensitive capture canaries; and explicit higher-layer gap reporting. Performance reports synchronous transport resources separately from native readiness paths.
