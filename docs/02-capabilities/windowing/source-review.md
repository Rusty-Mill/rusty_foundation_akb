...
| [Xlib manual](https://www.x.org/releases/current/doc/libX11/libX11/libX11.html) | X.Org living/current documentation; reviewed 2026-08-08 | X11 placement/root-coordinate and event mechanisms | compatible as provider-specific extension evidence; X11 guarantees cannot strengthen portable Wayland-compatible semantics |
