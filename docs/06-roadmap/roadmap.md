...
The [application data persistence and database foundations analysis](../02-capabilities/persistence/README.md) defines logical data/query models, typed sessions/pools/statements, transaction/isolation/durability boundaries, constraints/indexes/concurrency, staged compatible migrations, change streams/outbox, backup/semantic restore/PITR, replication/failover, cross-cutting qualities, conformance, and staged fault benchmarks across embedded and service providers. The [windowed desktop foundation profile](../02-capabilities/profiles/foundation-windowed-desktop.md) version 0.40.0, [server foundation profile](../02-capabilities/profiles/foundation-server.md) version 1.12.0, [repository-operator profile](../02-capabilities/profiles/foundation-repository-operator.md) version 0.8.0, and [CA-operator profile](../02-capabilities/profiles/foundation-ca-operator.md) version 0.7.0 compose persistence conditionally while preserving engines/dialects/schemas/queries/topologies/migrations/domain effects. Next gate is object/blob and content-addressed storage foundations: object identity/versioning, buckets/namespaces, immutable and conditional operations, streaming/multipart transfer, checksums/digests, consistency/listing, metadata/tags, encryption, delegated URLs, lifecycle/retention/legal hold, replication, inventory, recovery, observability, conformance, and benchmarks. A general graphics command model remains deferred until multiple renderer workloads justify it.
