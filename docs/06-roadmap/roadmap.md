...
The [HTTP client and server foundations analysis](../02-capabilities/networking/http-README.md) defines version-independent HTTP semantics over explicit HTTP/1.1-/2-/3 mechanics, bounded streaming/backpressure, connection selection/pooling/draining, redirects/challenges/replay/hedging, proxies/gateways/tunnels, partitioned caching, server admission/dispatch/shutdown, cross-cutting qualities, conformance, and staged benchmarks. The [windowed desktop foundation profile](../02-capabilities/profiles/foundation-windowed-desktop.md) version 0.36.0, [server foundation profile](../02-capabilities/profiles/foundation-server.md) version 1.8.0, [repository-operator profile](../02-capabilities/profiles/foundation-repository-operator.md) version 0.4.0, and [CA-operator profile](../02-capabilities/profiles/foundation-ca-operator.md) version 0.3.0 compose HTTP conditionally while preserving route/media/schema/domain policy. Next gate is real-time application transports—WebSocket, server-sent events, and WebTransport—covering handshake/origin/authentication, framing, streaming/backpressure, compression, reconnect/resumption/replay, proxies, close, observability, conformance, and benchmarks; a general graphics command model remains deferred until multiple renderer workloads justify it.
