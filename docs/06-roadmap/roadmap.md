...
The [real-time application transport foundations analysis](../02-capabilities/networking/realtime-README.md) defines common policy-bound session establishment plus distinct WebSocket messages, SSE event streams, and versioned WebTransport streams/datagrams; it covers origins/authentication, protocol revisions/extensions, flow/queues, liveness, close/drain, new-generation reconnect, application-scoped resume/reconciliation, cross-cutting qualities, conformance, and staged benchmarks. The [windowed desktop foundation profile](../02-capabilities/profiles/foundation-windowed-desktop.md) version 0.37.0, [server foundation profile](../02-capabilities/profiles/foundation-server.md) version 1.9.0, [repository-operator profile](../02-capabilities/profiles/foundation-repository-operator.md) version 0.5.0, and [CA-operator profile](../02-capabilities/profiles/foundation-ca-operator.md) version 0.4.0 compose these transports conditionally while preserving application schemas, subprotocols, acknowledgments, and domain authority. Next gate is application messaging and RPC foundations across HTTP, real-time transports, and IPC: typed envelopes/schema evolution, unary and streaming calls, correlation/deadlines/cancellation, authentication/authorization, delivery/ordering/acknowledgment/deduplication, pub/sub and durable-broker boundaries, error compatibility, observability, conformance, and benchmarks. A general graphics command model remains deferred until multiple renderer workloads justify it.
