...
The [repository publication and security-response foundations analysis](../04-ecosystem/repository-operations/README.md) defines separated roles and ceremonies, immutable release records, namespace succession, digest-preserving channel promotion, yank/deprecation/revocation overlays, coherent metadata and untrusted mirrors, retention/backup, exact revisioned advisories, coordinated disclosure, emergency recovery, conformance, and operational benchmarks. The [repository-operator foundation profile](../02-capabilities/profiles/foundation-repository-operator.md) version 0.1.0 composes these responsibilities while preserving explicit protocol, storage/coordination, format/provider, legal, staffing, and service-objective choices. Next gate is certificate issuance, enrollment, automated renewal, key attestation/proof-of-possession, and CA lifecycle foundations; a general graphics command model remains deferred until multiple renderer workloads justify it.
