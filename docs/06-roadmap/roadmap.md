...
The [certificate issuance, enrollment, and CA-lifecycle foundations analysis](../02-capabilities/security/pki-issuance-README.md) defines typed enrollment operations, identity/identifier authority, immutable requests and POP/attestation, policy-driven certificate construction, ACME/EST/SCEP/CMP/native mappings, response delivery and key-bound installation, renewal/rekey/replacement/revocation, CA roles/ledger/key ceremonies/hierarchy/recovery, conformance, and staged benchmarks. The [windowed desktop foundation profile](../02-capabilities/profiles/foundation-windowed-desktop.md) version 0.34.0, [server foundation profile](../02-capabilities/profiles/foundation-server.md) version 1.6.0, [repository-operator profile](../02-capabilities/profiles/foundation-repository-operator.md) version 0.2.0, and [CA-operator profile](../02-capabilities/profiles/foundation-ca-operator.md) version 0.1.0 compose client and operator responsibilities while preserving product trust/protocol/provider policy. Next gate is secure transport/channel foundations covering TLS, QUIC, authentication, negotiation, resumption, early data, channel binding, key updates, shutdown, and protocol evidence; a general graphics command model remains deferred until multiple renderer workloads justify it.
