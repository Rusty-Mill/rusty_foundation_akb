...
| Ownership | Unknown | accountable roles defined; named people and availability absent (independence itself is no longer a separate blocker once named, per [RFC-0004](../../rfc/0004-solo-maintainer-review-sufficiency.md)'s solo-maintainer mode) | Authorizing maintainer: unnamed | blocks authorization |
