...
| Measure | Result |
|---|---:|
| Markdown documents | 1,053 |
| Resolved internal links | 1,619 |
| Unique normative requirements | 4,919 |
...
- 1 domain README files lack the canonical table-form status field; this is recorded as a migration-quality issue, not silently interpreted as Stable.
