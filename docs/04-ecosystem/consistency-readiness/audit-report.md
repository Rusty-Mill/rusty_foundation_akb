...
| Measure | Result |
|---|---:|
| Markdown documents | 1,131 |
| Resolved internal links | 2,149 |
| Unique normative requirements | 5,255 |
| Capability domains | 62 |
| Indexed ADRs | 159 |
| External source URLs inventoried | 634 |
| External URLs with schema-valid domain review | 56 |
| Structural errors | 0 |
...
| Direct requirement-to-assertion map | 7 / 62 | 11.3% |
| Direct benchmark-requirement-to-scenario map | 7 / 62 | 11.3% |
...
| Source-declared typed edges | 16 |
...
|---|---:|---:|
| Dedicated `cross-cutting.md` | 29 / 62 | 46.8% |
| Embedded/unreviewed | 33 / 62 | 53.2% |
...
- 7 domain(s) have a complete direct planned requirement-to-assertion map; repository-wide migration remains open.
- 7 domain(s) have complete benchmark-requirement-to-scenario maps across 48 stable semantic scenarios; run evidence remains absent by design.
- 7 domain(s) have both complete planned assertion and benchmark traceability.
- 5 domain(s) are currently eligible for Experimental promotion; generated scorecards cannot authorize promotion.
- 5 domain(s) have schema-valid Proposed promotion reviews and 0 have Accepted reviews.
